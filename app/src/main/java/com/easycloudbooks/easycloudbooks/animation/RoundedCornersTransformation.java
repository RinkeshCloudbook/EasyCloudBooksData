...
package com.easycloudbooks.easycloudbooks.animation;
...
public class RoundedCornersTransformation implements Transformation<Bitmap> {
    private static final String ID = "RoundedCornersTransformation.com.bumptech.glide.load.resource.bitmap.x:0.y:0";
    ...
    @Override
    public Resource<Bitmap> transform (Context context,Resource<Bitmap> resource, int radius, int margin) {
        return transform( resource,radius,margin);
    }
