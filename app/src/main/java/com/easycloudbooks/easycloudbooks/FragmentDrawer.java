...
import com.easycloudbooks.easycloudbooks.adapter.NavDrawerAdapter;
...
//        mNavHeaderContainer = (RelativeLayout) layout.findViewById(R.id.nav_header_container);
        ...
        adapter = new NavDrawerAdapter(navTitles, navIcons, getActivity(),getActivity());
    ...
    public void ChangeContext()
    {
        if(adapter != null)
        {
            adapter.ChangeContext(getActivity());
        }
    }
