		...
		switch (typeface) {
			...
			case Roboto.ROBOTO_LIGHT:
				if (Roboto.sRobotoLight == null) {
					Roboto.sRobotoLight = ResourcesCompat.getFont(context, R.font.roboto_light);
				}
			...
			case Roboto.ROBOTO_THIN_ITALIC:
				if (Roboto.sRobotoThinItalic == null) {
					Roboto.sRobotoThinItalic = Typeface.createFromAsset(context.getAssets(), "fonts/roboto_thinitalic.ttf");
				}
