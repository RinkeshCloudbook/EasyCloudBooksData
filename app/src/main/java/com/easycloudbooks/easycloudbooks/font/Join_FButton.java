...
public class Join_FButton extends RelativeLayout implements View.OnTouchListener {
    //Custom values
    ...
    Context context ;
    public Join_FButton(Context context) {
        super(context);
    ...
    public Join_FButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        mInflater = LayoutInflater.from(context);
        this.context = context;
        init();
    ...
    public Join_FButton(Context context, AttributeSet attrs, int defStyle) {
